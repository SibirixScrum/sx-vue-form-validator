...
export function emailOrPhone(val) {
...
export function fileIsImage(val) {
...
export function fileSize(size = 1) {
    return (val) => {
...
export function requiredIfEmpty(prop = '') {
    return function (val) {
...
export function requiredIf(prop = '') {
    return function (val) {
        if (!!this[prop]) {
            return required(val);
        }
